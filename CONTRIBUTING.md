...
1. Make an [Issue](https://github.com/flopmongers/unity-extended/issues/new)
...
```json
    {
        "dependencies": {
            "com.flopmongers.unity-extended": "https://github.com/YOUR_USER/unity-extended.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at flopmongers@gmail.com.
